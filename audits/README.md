...
| [workflow-standards.md](workflow-standards.md) | Permissions, naming, self-hosted runners, static runner tags, devpi cache fallback, linting, PIPESTATUS, flake8wrap |
