...
| 2026-09-01 | [Audit scripts restructure](PLAN-audit-scripts-restructure.md) | Turn the 6,657-line audit checker into a package of check classes with a GitHub seam, so a criterion is one module and every check is testable | In progress |
