...
it by
[npm-pin-indirect-dependencies.md](npm-pin-indirect-dependencies.md).
...
[unused-declared-dependency.md](unused-declared-dependency.md) has the
...
[the compliance page](compliance.md#npm-unused-declared-dependency).
