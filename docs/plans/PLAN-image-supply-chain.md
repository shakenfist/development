...
resolved; occystrap#143 and shakenfist#4306 are still open, and
4f to 4j remain. shakenfist#4309 unblocked the guest-image half
on 2026-09-23.
...
and neither of them touches that repository.
...
**Three numbers drifted while the phase waited, all in
`shakenfist` `functional-tests.yml` and all by the same two
lines.** The matrix lane in 4g's item (2) was `:475` and is
`:477`; the node-lifecycle caller in 4f's brief and in the
definition of done was `:558` and is `:560`; the upload in 4g's
item (4) was `:583` and is `:585`. Every content at those sites is
...
instead of checking it. This is the fourth, fifth and sixth time a
line number in this phase has moved under ordinary work in that
repository. The survey's own numbers are left as it recorded them
on 2026-09-19 -- `:477`, `:515`, `:558`, `:583` -- because that
section is a dated snapshot and renumbering half of it would make
