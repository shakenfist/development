...
absence is a failure of the [renovate](renovate.md) criterion, and one
...
[unused-declared-dependency.md](unused-declared-dependency.md).
...
[the compliance page](compliance.md#renovate-lockstep-groups).
