...
[pin-indirect-dependencies.md](pin-indirect-dependencies.md) asks a
...
and
[npm-undeclared-direct-dependency.md](npm-undeclared-direct-dependency.md),
...
[the compliance page](compliance.md#npm-pin-indirect-dependencies).
