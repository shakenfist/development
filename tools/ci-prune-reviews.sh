...
# mirrors this repository's scripts/commit-audit-docs.sh landing
# pattern. Prune only ever removes marks, so this unsigned bot commit
# does not weaken the review attestations -- those live in the signed
# commits that introduced the stamps. See the steady state section of
