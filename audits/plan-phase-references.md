...
| kerbside | non-compliant | shakenfist/kerbside#294 |
...
- **kerbside** (Status): 11 plan phase reference(s) in documentation (describe the current behaviour, or link the master plan in docs/plans/ instead of citing a phase number): docs/console-sources.md:176, docs/console-sources.md:237, docs/proxy-architecture.md:280, docs/proxy-architecture.md:287, docs/proxy-architecture.md:327, docs/proxy-architecture.md:330, docs/proxy-architecture.md:354, docs/testing.md:9, docs/testing.md:134, docs/testing.md:196 (+1 more)
